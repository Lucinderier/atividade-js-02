...
*/
let phrase = 'Grandes poderes trazem grandes responsabilidades.';
/*console.log (phrase)
/*console.log('phrase')
/*
...
const js = programmingLanguage.charAt(0) + programmingLanguage.charAt(programmingLanguage.length - 6);
...
*/
/*const sizeConst= `o tamanho da constante "${programingLanguage}" é de: ${programmingLanguage.length} caracteres
...
/*console.log(`A ultima letra da string: ${randomWord} é a letra: ${randomWord[randomWord.length - 1]}`)
...
- Abaixo deste comentário, armazene o resto de 10 dividido por 3 em uma constante*correção: Let "reminder";
...
/*console.log(`${name[0].toUpperCase()}${name.slice(1, 6)} {}`)